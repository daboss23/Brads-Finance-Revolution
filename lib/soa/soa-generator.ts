...
import { buildAthenaDemoSections, isShowpieceClient } from "./demo-soa";
...
export function generateSoa(
  ...
  // Ensure projection paragraph reflects actual numbers for non-Athena clients
