// Hand crafted SOA for Athena Mitchell — the showpiece demo. Realistic
...
const ATHENA_BODIES: Record<string, string> = {
  ...
  implementation:
    "1. Sign and return this SOA. Responsible: Athena. By: within 14 days.\n2. Brad submits salary sacrifice instruction to Hunter Valley Health Network payroll. Responsible: Brad. By: within 7 days of signed SOA.\n3. Athena completes AIA application with health questions. Responsible: Athena. By: within 14 days. Provides: most recent payslip, Medicare details.\n4. Brad lodges AIA application and manages underwriting. Responsible: Brad. By: ongoing until cover commences.\n5. Brad submits AustralianSuper investment option switch. Responsible: Brad. By: within 7 days. Provides: member number AU-4421987.\n6. Athena opens FHSS contribution tracking in MyGov. Responsible: Athena. By: within 14 days.\n7. First annual review. Responsible: Brad and Athena. By: 12 months from sign date.",
...
export function buildAthenaDemoSections(): SoaSectionContent[] {
...
export function isShowpieceClient(clientId: string): boolean {
  return clientId === "athena-mitchell";
}
