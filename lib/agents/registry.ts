...
export const AGENT_REGISTRY: Record<AgentId, AgentDefinition> = {
  ...
  orion: {
    ...
    description: "Builds the approved evidence packet Atlas uses for tailored SOA drafting, including fact highlights, compliance notes and projection inputs.",
  ...
  atlas: {
    ...
    description: "Synthesises approved facts, compliance guardrails, meeting context, knowledge chunks and projection assumptions into Brad-ready SOA strategy output.",
