    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-xl onboarding-fade-in space-y-8">
        ...
        <div className="text-center">
          <p className="text-[10px] font-bold tracking-[0.25em] uppercase text-gold/55 mb-3">
        ...
        <div className="rounded-xl border border-gold/20 bg-card overflow-hidden">
          ...
          <div className="px-8 py-10 text-center">
            ...
            <p className="text-[9px] font-bold tracking-[0.28em] uppercase text-muted-foreground/35 mb-6">
              This certifies that
            </p>

            <p className="text-[26px] font-semibold tracking-tight text-gold mb-1.5">
              {clientFullName}
            </p>
            <p className="text-[13px] text-muted-foreground/45 mb-8">
            ...
            <div className="grid grid-cols-2 gap-2 mb-8 text-left">
              {FACT_FIND_SECTIONS.map((s) => (
                <div key={s.id} className="flex items-center gap-2">
                  ...
                  <span className="text-[12px] text-muted-foreground/55">{s.title}</span>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center justify-center gap-8">
              <div className="text-center">
                <p className="text-[22px] font-semibold text-gold tabular-nums">{xpEarned.toLocaleString()}</p>
                <p className="text-[9px] font-bold tracking-[0.2em] uppercase text-muted-foreground/30 mt-0.5">XP Earned</p>
              </div>
              <div className="h-8 w-px bg-border/50" />
              <div className="text-center">
                <p className="text-[22px] font-semibold text-foreground/65 tabular-nums">{completionPct}%</p>
                <p className="text-[9px] font-bold tracking-[0.2em] uppercase text-muted-foreground/30 mt-0.5">Completion</p>
              </div>
              <div className="h-8 w-px bg-border/50" />
              <div className="text-center flex flex-col items-center gap-1">
                <Calendar className="h-4 w-4 text-foreground/40" />
                <p className="text-[11px] text-muted-foreground/45">{completedDate}</p>
              </div>
            </div>
          </div>

          <div className="border-t border-border/40 bg-card-elevated/40 px-8 py-4 text-center">
            <p className="text-[11px] text-muted-foreground/35">
              Prepared in partnership with{" "}
              <span className="text-muted-foreground/55 font-medium">Brad Lonergan</span>
              {" "}·{" "}
              <span className="text-muted-foreground/55 font-medium">Newcastle Financial Services</span>
            </p>
          </div>
        ...
        <div className="rounded-lg border border-border/50 bg-card px-6 py-5">
          <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-blue-accent/60 mb-3">
            What happens next
          </p>
          <ul className="space-y-2.5">
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                <span className="mt-[9px] h-[3px] w-[3px] shrink-0 rounded-full bg-gold/40" />
                <p className="text-[13px] text-muted-foreground/60 leading-relaxed">{item}</p>
              </li>
            ))}
          </ul>
        </div>
