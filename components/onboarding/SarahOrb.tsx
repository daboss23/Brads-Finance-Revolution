  ...
  useEffect(() => {
    ...
    function render() {
      ...
      const cycledColor: [number, number, number] | undefined =
        cfg.hueCycle > 0.01 ? cyclePalette(elapsedSec * 0.15) : undefined;
