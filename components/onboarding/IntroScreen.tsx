    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-[600px] onboarding-fade-in space-y-9">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-[10px] font-bold tracking-[0.22em] uppercase text-gold mb-2.5">
              Sarah · Onboarding Guide
            </p>
            <h1 className="text-[36px] font-semibold tracking-tight text-foreground leading-tight">
              Hi, {firstName}.
            </h1>
            <p className="text-[18px] font-light text-muted-foreground/65 leading-snug mt-1.5">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <div key={label} className="rounded-lg border border-border bg-card px-5 py-5 text-center">
              <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-muted-foreground/45 mb-2.5">
                {label}
              </p>
              <p className="text-[14px] font-semibold text-foreground/85">{value}</p>
            </div>
          ))}
        </div>
